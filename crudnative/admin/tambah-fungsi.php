...
if(isset($_POST['tambah'])) {
    $insertSql = mysqli_query($conf, "INSERT into mhs(nm_mhs,nim,jk,id_kelas,username,password,photos) values('$_POST[nm_mhs]','$_POST[nim]','$_POST[jk]','$_POST[id_kelas]','$_POST[username]','$_POST[password]','$_POST[photos]')");
    if ($insertSql){
